...
db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS users ( jid TEXT PRIMARY KEY, last_interaction INTEGER, limit_usage INTEGER DEFAULT 0, last_limit_reset INTEGER, is_premium BOOLEAN DEFAULT 0, premium_expires_at INTEGER, last_claim INTEGER DEFAULT 0 );
...
const _statements = {
    ...
    getUserForLimiting: db.prepare('SELECT jid, limit_usage, last_limit_reset, is_premium, premium_expires_at, last_claim FROM users WHERE jid = ?'),
